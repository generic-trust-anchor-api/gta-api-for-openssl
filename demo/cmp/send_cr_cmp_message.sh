...
echo "Send cmp"
openssl cmp -server pki.certificate.fi:8700/pkix/ -secret pass:insta -recipient "/C=FI/O=Insta Demo/CN=Insta Demo CA" -ref 3078 -subject "/CN=openssl-cmp-provider-test" -cmd cr -certout "$CMP_CREDENTIAL_DIR/test.cert.pem" -newkey "$CMP_CREDENTIAL_DIR/gta-key.pem" -verbosity 8 -total_timeout 10
