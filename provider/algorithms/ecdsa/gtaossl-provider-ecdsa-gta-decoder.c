...
static OSSL_FUNC_decoder_decode_fn gtaossl_provider_ecdsa_gta_decoder_decode;
static OSSL_FUNC_decoder_does_selection_fn gtaossl_provider_ecdsa_gta_does_selection;
 ...
 */
static int gtaossl_provider_ecdsa_gta_decoder_decode(
    void * ctx,
    OSSL_CORE_BIO * cin,
    int selection,
    ...
    void * pw_cbarg)
{
    LOG_INFO("Decode GTA object to EC object");
    LOG_DEBUG_ARG("CALL_FUNC(%s)", __func__);
    return gtaossl_provider_base_gta_decoder_decode(
        ctx, cin, selection, object_cb, object_cbarg, pw_cb, pw_cbarg, PREQS_EC);
}
 ...
 */
static int gtaossl_provider_ecdsa_gta_does_selection(void * provctx, int selection)
{
...
const OSSL_DISPATCH gta_to_ecdsa_decoder_functions[] = {
    ...
    {OSSL_FUNC_DECODER_DECODE, (void (*)(void))gtaossl_provider_ecdsa_gta_decoder_decode},
    {OSSL_FUNC_DECODER_DOES_SELECTION, (void (*)(void))gtaossl_provider_ecdsa_gta_does_selection},
